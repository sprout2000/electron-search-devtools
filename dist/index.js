...
const searchDevtools = (arg, options) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!(0, exports.typeGuardOptions)(options)) {
        console.log('The option should be an object containing the name of the profile or browser.');
        return;
    }
    const providedOptions = (0, exports.getOptions)(options);
    const devtools = (0, exports.whichDevtools)(arg, providedOptions.profile);
    const devtoolsName = `${arg.charAt(0)}${arg.slice(1).toLowerCase()} Devtools`;
    const dirPath = path_1.default.join(os_1.default.homedir(), (0, exports.getExtDir)(os_1.default.platform(), providedOptions.browser), devtools);
